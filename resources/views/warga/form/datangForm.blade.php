            ...
            <form class="mt-3 mb-2" action="{{ route('warga.pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf                    
                    ...
                    <div class="form-group col-md-8">
                      ...
                      <div class="form-group col-md-8">
                        <label for="inputState">Tempatlahir</label>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <select name="tujuan_kk" class="form-control" required>
                    ...
                    <div class="form-group col-md-8">
                        <label for="inputState">Nomor Kartu Keluarga</label>
                        <input class="form-control" type="text" name="tujuan_no_kk" required >
                    </div>
                    <div class="form-group col-md-8">
                        <label for="inputState">Nama Kepala Keluarga</label>
                        <input class="form-control" type="text" name="tujuan_nama_kk" required >
                    </div>
                     
                    <div class="form-group col-md-8">
                        <label for="inputState">Tanggal Kedatangan</label>
                        <input class="form-control" type="text" name="tgl_datang" required>
                    </div>
                    <div class="form-group col-md-8">

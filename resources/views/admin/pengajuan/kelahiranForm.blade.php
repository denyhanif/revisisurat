            ...
            <form class="mt-3 mb-2" action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf                    
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input class="form-control" type="text" name="nama_bayi" >
                    </div> 
                    <div class="form-group col-md-8">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input class="form-control" type="text" name="tmpt_lahiran" >
                    </div> 
                    <div class="form-group col-md-8">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input class="form-control" type="text" name="hari_lahir" >
                    </div>    
                    <div class="form-group col-md-8">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input class="form-control" type="text" name="jam_lahir" >
                    </div>      
                    <div class="form-group col-md-8">
